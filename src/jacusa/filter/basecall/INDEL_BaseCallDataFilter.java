...
public class INDEL_BaseCallDataFilter<T extends AbstractData & hasBaseCallCount & hasINDEL_DistanceFilterData> 
extends AbstractBaseCallDataFilter<T> {

	public INDEL_BaseCallDataFilter(final char c, 
			final int overhang, 
	...
	protected BaseCallCount getFilteredBaseCallData(final ParallelData<T> parallelData, final int conditionIndex, final int replicateIndex) {
		return parallelData.getData(conditionIndex, replicateIndex).getINDEL_DistanceFilterData();
	}
