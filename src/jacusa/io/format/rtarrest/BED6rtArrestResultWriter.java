...
public class BED6rtArrestResultWriter<T extends AbstractData & HasReferenceBase & HasRTarrestCount & HasArrestBaseCallCount & HasThroughBaseCallCount, R extends Result<T> & hasStatistic> 
