package test.jacusa.filter.factory.basecall;
...
class BaseCallCountFilterFactoryTest {
	...
	void testProcessCLICommandLine(
			AbstractBaseCallCountFilterFactory testInstance,
			String line, 
