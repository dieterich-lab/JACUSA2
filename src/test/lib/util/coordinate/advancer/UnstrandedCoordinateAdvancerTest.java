...
import lib.util.coordinate.advancer.UnstrandedCoordinateAdvancer;

class UnstrandedCoordinateAdvancerTest extends AbstractCoordinateAdvancerTest {

	public UnstrandedCoordinateAdvancerTest() {
	...
	protected Stream<Arguments> testAdvance() {
		return Stream.of(
				Arguments.of(
						c("1", 10, 10, STRAND.UNKNOWN), 5, c("1", 15, 15, STRAND.UNKNOWN)),
				Arguments.of(
						c("1", 10, 10, STRAND.REVERSE), 1, c("1", 11, 11, STRAND.REVERSE)),
				Arguments.of(
						c("1", 10, 10, STRAND.REVERSE), 1, c("1", 11, 11, STRAND.REVERSE)),
				Arguments.of(
						c("1", 10, 10, STRAND.FORWARD), 2, c("1", 12, 12, STRAND.FORWARD)) );
	}
