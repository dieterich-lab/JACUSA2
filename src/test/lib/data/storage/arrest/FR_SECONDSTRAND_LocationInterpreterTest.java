...
class FR_SECONDSTRAND_LocationInterpreterTest implements LocationInterpreterTest {

	private static final String CONTIG = "LocationInterpreterTest";

	private final LibraryType libType;
	
	public FR_SECONDSTRAND_LocationInterpreterTest() {
		libType = LibraryType.FR_SECONDSTRAND;
	}
