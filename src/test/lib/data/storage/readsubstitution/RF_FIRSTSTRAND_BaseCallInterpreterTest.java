...
class RF_FIRSTSTRAND_BaseCallInterpreterTest extends AbstractBaseCallInterpreterTest {
	
	public RF_FIRSTSTRAND_BaseCallInterpreterTest() {
		super(BaseCallInterpreter.build(LibraryType.RF_FIRSTSTRAND));
	}
