...
public class ProcessedRecord {
	...
	public ProcessedRecord(final SAMRecord record) {
		this(record, null);
	}
	
	public ProcessedRecord(final SAMRecord record, final SamReader mateReader) {
		this(record, null, mateReader);
	}
	
	private ProcessedRecord(final SAMRecord samRecord, final ProcessedRecord mate, final SamReader mateReader) {
	...
	public ProcessedRecord getMate() {
		if (! samRecord.getReadPairedFlag()) {
			return null;
		}
		if (mate == null) {
			final SAMRecord mateRecord = mateReader.queryMate(samRecord);
			mate = new ProcessedRecord(mateRecord, this, mateReader);
		}
		return mate;
	}
