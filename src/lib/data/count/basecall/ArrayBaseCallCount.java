...
public class ArrayBaseCallCount extends AbstractBaseCallCount {
	...
	@Override
	public ArrayBaseCallCount add(final BaseCallCount bcc) {
	...
	@Override
	public ArrayBaseCallCount add(final Base base, final BaseCallCount bcc) {
		add(base, base, bcc);
		return this;
	}

	@Override
	public ArrayBaseCallCount add(final Base dest, final Base src, final BaseCallCount bcc) {
		baseCalls[dest.getIndex()] += bcc.getBaseCall(src);
		return this;
	}

	@Override
	public ArrayBaseCallCount subtract(final Base base, final BaseCallCount bcc) {
		subtract(base, base, bcc);
		return this;
	}

	@Override
	public ArrayBaseCallCount subtract(final Base dest, final Base src, final BaseCallCount bcc) {
		this.baseCalls[dest.getIndex()] -= bcc.getBaseCall(src);
		return this;
	}

	@Override
	public ArrayBaseCallCount subtract(final BaseCallCount bcc) {
		for (final Base base : bcc.getAlleles()) {
			subtract(base, bcc);
		}
		return this;
