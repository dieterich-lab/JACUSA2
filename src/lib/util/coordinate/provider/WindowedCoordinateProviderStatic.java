...
public class WindowedCoordinateProviderStatic implements CoordinateProvider {
	...
	public WindowedCoordinateProviderStatic(final boolean stranded, final Coordinate coordinate, final int windowSize) {
	...
	public WindowedCoordinateProviderStatic(final boolean stranded, final CoordinateProvider cp, final int windowSize) {
